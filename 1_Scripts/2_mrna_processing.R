...
png("2_Figures/exp_vals_before_norm.png",width=1000)
explo.plot(counts_data, plottype = "boxplot")
dev.off()

# Expression values in CPM for cancer samples and controls
png("2_Figures/exp_vals_bar_before_norm.png",width=1000)
...
png("2_Figures/transcript_bias_before_norm.png",width=1000)
...
png("2_Figures/exp_val_bar_after_norm.png",width=1000)
