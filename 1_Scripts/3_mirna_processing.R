...
png("2_Figures/mir_vals_before_norm.png",width=1000)
explo.plot(counts_data, plottype = "boxplot")
dev.off()

# Expression values in CPM for cancer samples and controls
png("2_Figures/mir_vals_bar_before_norm.png",width=1000)
...
cpm_hist
ggsave("2_Figures/mir_cpm_before_norm.png", plot = cpm_hist)                # Save plot 
...
png("2_Figures/mir_gc_bias_before_norm.png",width=1000)
...
png("2_Figures/mir_length_bias_before_norm.png",width=1000)
explo.plot(len_bias)
dev.off()
...
png("2_Figures/mir_batch_effect_before_norm.png",width=1000)
...
png("2_Figures/mir_batch_effect_after_norm.png",width=1000)
...
png("2_Figures/mir_val_bar_after_norm.png",width=1000)
...
mir_eigen<- mfa_normalize(new_noiseq@assayData$exprs)
...
## Plot itself
png("2_Figures/mir_diff_plot.png",width=1000)
